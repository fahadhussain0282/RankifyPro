    ...
    <div className="pb-32 bg-[#050505]">
      <section className="pt-24 pb-48 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            Stay ahead of the curve with our expert guides on ranking higher, growing traffic, and dominating the search engine landscape.
          </motion.p>
        </div>
      </section>
          ...
          {BLOG_POSTS.map((post) => (
            ...
            >
              ...
              <div className="p-10 flex-grow flex flex-col">
                <div className="flex items-center space-x-6 text-xs font-bold uppercase tracking-widest text-slate-500 mb-6">
